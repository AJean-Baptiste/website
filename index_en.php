  ...
  <body>
	...
	<div class="about" id="about">
		...
		<div class="bio">
			...
			<div>
				<p>Young programming student passionate about science, I recently decided to reorient myself towards web development by applying to MyDigitalSchool in 3rd year.</p>
				<br>
		...
		<div class="separator">
			<div class="news">
				<h3>Searching for a work-study program</h3>
				<p>Following my application to MyDigitalSchool, I am currently looking for a work-study contract in Montpellier</p>
				<br>
				<p>I am ready to invest 100% in innovative projects, having a great thirst for learning, work does not scare me. I am eager to invest myself in a company and to discover all the tricks of the trade.</p>
				<div class="atouts">
					<h3>Strengths</h3>
					<h4>Front-end:</h4>
